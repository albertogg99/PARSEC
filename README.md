# PARSEC
Versión modernizada del *benchmark* PARSEC. Este repositorio incluye 8 de las aplicaciones del *benchmark* original (para descargar la versión original visita https://parsec.cs.princeton.edu/), las cuales han sido modernizadas durante mi Trabajo Fin de Grado: ***Estudio de la calidad de software en benchmarks científicos***. El objetivo de este proyecto era investigar el impacto de la calidad del software sobre el rendimiento de las aplicaciones. 
